...
Pers [fluf],  — 3:40 PM
interesting
trollmeight [BLOX],  — 3:41 PM
ok i blocked googleapi domains
HUHH
IT ENROLLED?
Pers [fluf],  — 3:41 PM
sob
trollmeight [BLOX],  — 3:42 PM
i think its my domains
i think i'm not doing enough
Pers [fluf],  — 3:42 PM
you should probably record the requests it makes while it enrolls
trollmeight [BLOX],  — 3:42 PM
yea i'll pull a wireshark
Pers [fluf],  — 3:42 PM
then block anything it uses for enrollment
trollmeight [BLOX],  — 3:43 PM
other than connectivitycheck.gstatic.com*
or else it completely goes kaput and doesn't let you continue
Pers [fluf],  — 3:43 PM
...
trollmeight [BLOX],  — 3:43 PM
idk gng
i'm gonna make a text editor now
wait you should make a text editor in bash
Pers [fluf],  — 3:43 PM
no
anyways
 [fluf], 
trollmeight [BLOX],  — 3:44 PM
son why
Pers [fluf],  — 3:45 PM
why would you need a text editor in vt2 😭
trollmeight [BLOX],  — 3:45 PM
oh true
i'm just making one for fun
aero text editor
Pers [fluf],  — 3:45 PM
👍
trollmeight [BLOX],  — 3:46 PM
ok this might be easy actually
Pers [fluf],  — 3:46 PM
ok while i think of ideas i will add exit option
trollmeight [BLOX],  — 3:46 PM
can't they just do control c
Pers [fluf],  — 3:47 PM
that was easy
i have no more ideas still
 [BLOX], 
Pers [fluf],  — 3:48 PM
yeah but some skids wont know ctrl c
trollmeight [BLOX],  — 3:48 PM
fair enough
ok hm
what will you need in vt2
ip grabber trust
i mean ip shower
whatever
curl ipinfo.io/json
cause what if someone needs their ip in vt2
Pers [fluf],  — 3:49 PM
sure
trollmeight [BLOX],  — 3:53 PM
but yea when you are done send me the files in dms and i can turn it into a curl command
 [BLOX], 
Pers [fluf],  — 3:59 PM
here can you do the gbb script
#!/bin/bash
# Created by Nikki
...
gbb.sh
1 KB
trollmeight [BLOX],  — 3:59 PM
not bad kid, not bad
curl -sSL http://trollmeight.me/ferrochrome/vt2/gbb.sh | bash
try this
wait, can't you just pull a "clear" instead of printf "\ec"
Pers [fluf],  — 4:07 PM
twin
can you also make this into a curl command
#!/bin/bash
